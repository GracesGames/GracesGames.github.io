...
{:.p-center}
[Play Here][gamejolt-kick-it]{:target="_blank"}

##### Motivation

Kick-It is a re-implementation and extension of my [XNA][wikipedia-xna]{:target="_blank"} game called _Sokoban - Goof Troop_, which is a trimmed down clone of the SNES game [Goof Troop][wikipedia-goof-troop]{:target="_blank"}. It focuses on the [Sokoban][wikipedia-sokoban]{:target="_blank"} inspired puzzles of the game.
...
Like many of my other games, Kick-It was developed in C# using the [Unity Engine][unity-3d]{:target="_blank"}. While some of the _Sokoban - Goof Troop_ code could be reused, the physics and other elements were re-implemented in a more modular and extensible way. This also resulted in simpler building blocks for the level editor.  
In addition, and matching the original [Goof Troop][wikipedia-goof-troop]{:target="_blank"} game, a two-player mode was added. This also makes solving puzzles more fun.  
To prevent copyright violations, public domain resources from [Kenney][kenney]{:target="_blank"} were used.

##### Status

The game is currently on hold to focus on other projects, but a prototype is available on [GameJolt][gamejolt-kick-it]{:target="_blank"}. Additional levels, building blocks and other features will be added at a later moment.
