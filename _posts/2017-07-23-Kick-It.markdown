...
Where the XNA demo used ripped assets, this time the game uses public domain assets, thereby allowing it to be published. By using the _2D Tile Map Level Editor_, the game also allows the players to create and share levels. 
...
The game is currently on hold to focus on other projects, but a prototype is already released with Early Access status on [GameJolt][gamejolt-kick-it]. Additional levels, building blocks and other features will be added at a later moment.
